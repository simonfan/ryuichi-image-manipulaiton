...
function faroShuffleDiscreteSequence(curve) {
  var rotations = [];
...
function faroShuffleContinuousSequence(curve) {
  var rotations = [];
...
// faroShuffleContinuousSequence(CURVES.easeInSine)

video.generateVideo({
  frames: faroShuffleContinuousSequence(CURVES.easeInSine),
  dest: __dirname + '/videos/faro-continuos-ease-in-sine-v3x.mp4',
