...
function mongeanShuffleDiscreteSequence(curve) {
  var rotations = [];
...
function mongeanShuffleContinuousSequence(curve) {
  var rotations = [];
...
// mongeanShuffleContinuousSequence(CURVES.easeInSine)

video.generateVideo({
  frames: mongeanShuffleContinuousSequence(CURVES.easeInSine),
  dest: __dirname + '/videos/mongean-continuos-ease-in-sine-v3x.mp4',
